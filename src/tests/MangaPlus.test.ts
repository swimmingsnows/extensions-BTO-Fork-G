...
import { Language } from '../MangaPlus/APIInterface'

describe('MangaPlus Tests', function () {
  var wrapper: APIWrapper = new APIWrapper()
  var source: Source = new MangaPlus(cheerio)
  ...
  it('Get Chapter Details', async () => {
    ...
    let data = await wrapper.getChapterDetails(source, mangaId, chapter.id)
    console.log(chapter)
