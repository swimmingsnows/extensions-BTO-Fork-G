...
},{"./Source":9,"./Tracker":10}],12:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });
...
},{"./base":11,"./models":55}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Button":16,"./Form":17,"./FormRow":18,"./Header":19,"./InputField":20,"./Label":21,"./Link":22,"./MultilineLabel":23,"./NavigationButton":24,"./OAuthButton":25,"./Section":26,"./Select":27,"./Stepper":28,"./Switch":29,"./WebViewButton":30}],32:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Parser":57,"paperback-extensions-common":12}],57:[function(require,module,exports){
"use strict";
...
class Parser {
    ...
    parseChapterList($, mangaId) {
        ...
        for (const obj of $('.p-1').toArray()) {
            ...
            const chapVol = Number((_b = (_a = chapName === null || chapName === void 0 ? void 0 : chapName.toLowerCase()) === null || _a === void 0 ? void 0 : _a.match(/season \D*(\d*\.?\d*)/)) === null || _b === void 0 ? void 0 : _b.pop());
            const chapNum = Number((_d = (_c = chapName === null || chapName === void 0 ? void 0 : chapName.toLowerCase()) === null || _c === void 0 ? void 0 : _c.match(/chapter \D*(\d*\.?\d*)/)) === null || _d === void 0 ? void 0 : _d.pop());
    ...
    filterUpdatedManga($, time, ids) {
        ...
        for (const item of $('div.flex.bg-color-bg-secondary.p-2.rounded').toArray()) {
            const id = (_b = (_a = $('a.inilne.block', item).attr('href')) === null || _a === void 0 ? void 0 : _a.replace('/manga/', '')) !== null && _b !== void 0 ? _b : '';
            const mangaTime = new Date((_c = $('time-ago', item).attr('datetime')) !== null && _c !== void 0 ? _c : '');
    ...
    parseSearchResults($) {
        ...
        for (const obj of $('div', $('.grid.gap-3')).toArray()) {
            const id = (_a = $('a', $(obj)).attr('href')) === null || _a === void 0 ? void 0 : _a.replace('/manga/', '');
